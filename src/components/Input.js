const Input = ({
  ...
  const inputClass = `block w-full px-3 py-2 rounded-lg border bg-surface text-ink dark:bg-surface-dark dark:text-ink-dark dark:placeholder:text-faint-dark placeholder:text-faint ${
